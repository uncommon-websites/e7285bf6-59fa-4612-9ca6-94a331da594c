		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="mailto:hello@weave.dev" class="hover:text-foreground">hello@weave.dev</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="#" class="hover:text-foreground">Code Scanning</a></li>
					<li><a href="#" class="hover:text-foreground">SDK Generation</a></li>
					<li><a href="#" class="hover:text-foreground">Event Monitoring</a></li>
					<li><a href="#" class="hover:text-foreground">Integrations</a></li>
					<li><a href="#" class="hover:text-foreground">Export Plans</a></li>
					<li><a href="#" class="hover:text-foreground">Demo</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					...
					<li><a href="#" class="hover:text-foreground">Frameworks</a></li>
